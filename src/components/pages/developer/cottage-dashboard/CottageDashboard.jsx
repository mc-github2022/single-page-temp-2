...
const CottageDashboard = () => {
  return (
    <>
      <section id="pricing" className="cottage py-20 bg-light">
        <div className="customContainer">
          <h2 className="text-[clamp(30px,5vw,48px)] w-full mb-20 md:w-[757px]  md:text-[48px] font-semibold lg:w-[50%] relative">
          ...
          <div className="wrapper grid grid-cols-1 md:grid-cols-2 md:gap-[40px]">
            <div className="roomItem mb-14 relative">
              <img
...
export default CottageDashboard;
